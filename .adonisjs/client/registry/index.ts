...
const routes = {
  ...
  'analytics.department_costs': {
    ...
    types: placeholder as Registry['analytics.department_costs']['types'],
  },
  'analytics.tools_by_category': {
    ...
    types: placeholder as Registry['analytics.tools_by_category']['types'],
  },
  'analytics.low_usage_tools': {
    ...
    types: placeholder as Registry['analytics.low_usage_tools']['types'],
  },
  'analytics.expensive_tools': {
    ...
    types: placeholder as Registry['analytics.expensive_tools']['types'],
  },
  'analytics.vendor_summary': {
    ...
    types: placeholder as Registry['analytics.vendor_summary']['types'],
  },
